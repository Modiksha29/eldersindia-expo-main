...
import getBlogs from 'apis/corporate/blogs'
...
const data =[
  {"id":"f47ba98a-7afb-38ef-bab5-5dde10fb578a","title":{"en":"Estate planning takes care of family's wealth after you"},"content":{"en":"Quam veniam vel sed doloribus hic in sit. Et eos qui consectetur sunt quod. Voluptatem quia ea quos."},"image":"https://app.eldersindia.com/uploads/vendor/banners//1669629187burfi%202.jpg","link":"/corporate/blogs/view/f47ba98a-7afb-38ef-bab5-5dde10fb578a/Sunt minus nobis doloremque","backgroundColor":"#F7F9FC"},

{"id":"8f80ba66-8b93-3a98-b071-7c741a67c9d9","title":{"en":"Know alzheimer's for caregivers and patients - dr sushma chawla"},"content":{"en":"Sequi possimus maxime voluptas mollitia. Aut unde neque quo sit reprehenderit vero."},"image":"https://app.eldersindia.com/uploads/vendor/banners//16662567841663760053564.jpg","link":"/corporate/blogs/view/8f80ba66-8b93-3a98-b071-7c741a67c9d9/Quo occaecati","backgroundColor":"#F7F9FC"},


{"id":"5c2ed941-2184-49fe-9de9-a05ed2b1e469","title":{"en":"Meet the unsung hero fighting for elderly parents"},"content":{"en":"Voluptates velit"},"image":"https://app.eldersindia.com/uploads/vendor/banners//1660730850New%20Project%20(5).jpg","link":"/corporate/blogs/view/5c2ed941-2184-49fe-9de9-a05ed2b1e469/blog titel","backgroundColor":"#F7F9FC"},
    ...
    onSuccess(data) {
      ...
      data.data?.data?.data?.map((l, i) => {
        ...
        list.push({
          ...
          // created_at,
          // author,
          link: `/corporate/blogs/${l.title['en']}?id=${l.id}&name=${l.title['en']}`,
        })
      })

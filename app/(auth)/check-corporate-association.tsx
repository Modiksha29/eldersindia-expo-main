    ...
    return (
        ...
        >
            <Layout style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: 100, paddingHorizontal: 16, backgroundColor: 'transparent' }}>
                ...
                >
                    <Text category='h5' style={{ textAlign: 'center', margin: 8, }}>{`Is your corporate employer partnered with EldersIndia?`}</Text>

                </MotiView>
                <MotiView style={{
                    flexDirection: 'row', justifyContent: 'center', flexWrap: 'wrap', alignItems: 'center', width: 320
                }}>
                    <Button status='warning' size='large' style={{ flex: 1, margin: 8 }} onPress={() => push('are-you-an-elder')}>No</Button>
                    <Button status='primary' size='large' style={{ flex: 1, margin: 8 }} onPress={() => push('add-corporate-email')}>Yes</Button>
                </MotiView>
            </Layout>
        </LinearGradient>
    )

...
// export function DeletedLastMilePartnerScreen() {
//   ////  const sx = useSx()
...
//       >
//         <Text category='h3' style={{ textAlign: 'center', margin: 8, }}>{`DeletedLastMilePartner`}</Text>
//       </MotiView>
                ...
                >
                    <MotiView style={{ flexDirection: "row" }}>
                        ...
                        <MotiView style={{ marginRight: 32 }}>
                            <>
                                <Text category='s1' style={{ justifyContent: "center", alignSelf: "center" }}>
                                    {`${faker.name.fullName()}`}
                            ...
                            <MotiView style={{ flexDirection: 'row', alignSelf: "flex-end", marginTop: 8 }} >
                                ...
                                <Button status='danger' appearance='outline' style={{ marginHorizontal: 4 }}
                                    // onPress={() => isPresented()}

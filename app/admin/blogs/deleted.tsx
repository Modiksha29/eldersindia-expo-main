...
import { getDestroiedBlogsRecord, updateBlogs } from 'apis/admin/blogs'
...
export default function Page() {
  ...
  const fetchBlogs = (page = 1, sort, search) => getDestroiedBlogsRecord(page, sort, search)
        ...
        >
          <MotiView style={{ flexDirection: "row" }}>
            ...
            <MotiView style={{ marginRight: 32, justifyContent: 'center' }}>
              ...
              <Text category='s1' style={{ marginLeft: 8, justifyContent: "center", }}>
                {`${item.title?.en}`}
  ...
  if (isError) {
    return <Layout level='1' style={{ flex: 1, justifyContent: 'center', alignItems: 'center', }}>
      ...
      <Text category='s1' status='warning' style={{ textAlign: 'center', marginVertical: 8 }}>Failed to get deleted blogs details.</Text>

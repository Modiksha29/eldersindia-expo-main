...
const BottomTabs = ({navigation, state}) => {
    ...
    return (
        ...
        onSelect={index => navigation.navigate(state.routeNames[index])}>
            ...
            <BottomNavigationTab icon={<Icon name="ios-shield-checkmark-outline" pack='ionicons'/>} title={`Approve`}/>
...
export default function Layout() {
    return (
        <Tabs initialRouteName='index' screenOptions={{headerShown: false}} tabBar={props => <BottomTabs {...props} />}>
            <Tabs.Screen name="(view)"></Tabs.Screen>
            <Tabs.Screen name="create"></Tabs.Screen>
            <Tabs.Screen name="approve"></Tabs.Screen>

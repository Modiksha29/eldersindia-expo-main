...
import { getDestroiedNewsRecord } from 'apis/admin/news'
...
export default function Page() {
  ...
  const fetchNews = (page = 1, sort, search) => getDestroiedNewsRecord(page, sort, search)
  ...
  const {
    ...
    // enabled: false,
    queryKey: ['deletedNews', page, sort, search],
  ...
  if (isError) {
    return <Layout level='1' style={{ flex: 1 , justifyContent:'center', alignItems: 'center',}}>
      ...
      <Text category='s1' status='warning' style={{ textAlign: 'center', marginVertical: 8 }}>Failed to get deleted news details.</Text>

import { useTheme, Text, Avatar, Button, Icon } from '@ui-kitten/components'
...
export const DrawerHeader = () => {
    ...
    return (
        ...
        >
            <MotiView style={{ paddingTop: 64, padding: 16, marginBottom: 16, flexDirection: "row", alignItems: 'center', justifyContent: 'flex-start' }}>
